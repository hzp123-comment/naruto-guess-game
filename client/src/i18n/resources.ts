export const resources = {
  zh: {
    translation: {
      ...
      home: {
        ...
        logoutConfirm: '退出账号',
        loginRegister: '登录 / 注册', singleMode: '单人模式', singleModeDescription: '选择难度后开始一局火影角色猜测',
        search: '查角色',
        searchDescription: '家族/组织、忍村与能力属性',
        multiplayer: '多人联机',
      ...
      player: {
        team: '家族/组织', nationality: '忍村', age: '年龄', role: '等级',
        majorChampionships: '冠军数', majorAppearances: '参赛次数', status: '生存状态', nickname: '角色名',
      ...
      game: {
        singleMode: '单人模式 · {{mode}}', restart: '重新开始', reveal: '查看答案',
        ...
        hint: '绿色正确 · 黄色接近 · 灰色错误', again: '再来一把', back: '返回菜单',
        startHint: '在下方输入角色名开始猜测', easyHint: '简单版：目标限定为知名度较高的角色',
      ...
      admin: {
        ...
        importDone: '导入完成：新增 {{created}}，更新 {{updated}}', jsonError: 'JSON 格式错误', nickname: '昵称', nationality: '忍村', region: '赛区', team: '队伍', age: '年龄', role: '等级', majorTitles: 'Major 冠军', major: 'Major', difficulties: '难度', status: '生存状态', pool: '选手池', actions: '操作',
  ...
  en: {
    translation: {
      ...
      common: {
        brand: '火影忍者猜猜猜', guest: 'Guest', home: 'Home', close: 'Close', cancel: 'Cancel', confirm: 'Confirm', loading: 'Loading...', noData: 'No data', unknown: 'Unknown',
